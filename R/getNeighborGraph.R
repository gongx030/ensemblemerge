...
#' @export
setMethod("getNeighborGraph", "SeuratParams", function(params, data, normalization_method = "LogNormalize", ...) {
...
#' @return returns a SingleCellExperiment object of the integrated data
#' @export
setMethod("getNeighborGraph", "HarmonyParams", function(params, data, normalization_method = "LogNormalize", ...) {
  params@return = "Seurat"
  params@norm_method = normalization_method
  ng <- Merge(params, data)
...
#' @return returns a SingleCellExperiment object of the integrated data
#' @export
setMethod("getNeighborGraph", "LigerParams", function(params, data, normalization_method = "LogNormalize", ...) {
  params@return = "Seurat"
  params@norm_method = normalization_method
  ng <- Merge(params, data)
...
#' @return returns a SingleCellExperiment object of the integrated data
#' @export
setMethod("getNeighborGraph", "BBKNNParams", function(params, data, normalization_method = "LogNormalize", ...) {
  params@return = "Seurat"
  ng <- Merge(params, data)
...
#' @return returns a SingleCellExperiment object of the integrated data
#' @export
setMethod("getNeighborGraph", "ScanoramaParams", function(params, data, normalization_method = "LogNormalize", ...) {
  params@return = "Seurat"
  ng <- Merge(params, data)
...
#' @return returns a SingleCellExperiment object of the integrated data
#' @export
setMethod("getNeighborGraph", "FastMNNParams", function(params, data, normalization_method = "LogNormalize", ...) {
  params@return = "Seurat"
  ng <- Merge(params, data)
...
#' @return returns a SingleCellExperiment object of the integrated data
#' @export
setMethod("getNeighborGraph", "scVIParams", function(params, data, normalization_method = "LogNormalize", ...) {
  params@return = "Seurat"
  ng <- Merge(params, data)
